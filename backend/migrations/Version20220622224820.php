 ...
 */
final class Version20220622224820 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE application (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, owner_id INTEGER NOT NULL, title VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, CONSTRAINT FK_A45BDDC17E3C61F9 FOREIGN KEY (owner_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__proxy_route AS SELECT id, application_id, pattern, client_pattern, is_protected, method, description FROM proxy_route');
        $this->addSql('DROP TABLE proxy_route');
        $this->addSql('CREATE TABLE proxy_route (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, application_id INTEGER NOT NULL, pattern VARCHAR(255) NOT NULL, client_pattern VARCHAR(255) NOT NULL, is_protected BOOLEAN NOT NULL, method VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, CONSTRAINT FK_DBB88A543E030ACD FOREIGN KEY (application_id) REFERENCES application (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO proxy_route (id, application_id, pattern, client_pattern, is_protected, method, description) SELECT id, application_id, pattern, client_pattern, is_protected, method, description FROM __temp__proxy_route');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__proxy_route AS SELECT id, application_id, pattern, client_pattern, is_protected, method, description FROM proxy_route');
        $this->addSql('DROP TABLE proxy_route');
        $this->addSql('CREATE TABLE proxy_route (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, application_id INTEGER NOT NULL, pattern VARCHAR(255) NOT NULL, client_pattern VARCHAR(255) NOT NULL, is_protected BOOLEAN NOT NULL, method VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL)');
        $this->addSql('INSERT INTO proxy_route (id, application_id, pattern, client_pattern, is_protected, method, description) SELECT id, application_id, pattern, client_pattern, is_protected, method, description FROM __temp__proxy_route');
        $this->addSql('DROP TABLE __temp__proxy_route');
        $this->addSql('CREATE INDEX IDX_DBB88A543E030ACD ON proxy_route (application_id)');
    }
