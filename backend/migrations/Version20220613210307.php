 ...
 */
final class Version20220613210307 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__proxy_route AS SELECT id, application_id, pattern, client_pattern, is_protected, method FROM proxy_route');
        ...
        $this->addSql('INSERT INTO proxy_route (id, application_id, pattern, client_pattern, is_protected, method) SELECT id, application_id, pattern, client_pattern, is_protected, method FROM __temp__proxy_route');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__proxy_route AS SELECT id, application_id, pattern, client_pattern, is_protected, method FROM proxy_route');
        $this->addSql('DROP TABLE proxy_route');
        $this->addSql('CREATE TABLE proxy_route (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, application_id INTEGER NOT NULL, pattern VARCHAR(255) NOT NULL, client_pattern VARCHAR(255) NOT NULL, is_protected BOOLEAN NOT NULL, method VARCHAR(255) NOT NULL)');
        $this->addSql('INSERT INTO proxy_route (id, application_id, pattern, client_pattern, is_protected, method) SELECT id, application_id, pattern, client_pattern, is_protected, method FROM __temp__proxy_route');
        $this->addSql('DROP TABLE __temp__proxy_route');
        $this->addSql('CREATE INDEX IDX_DBB88A543E030ACD ON proxy_route (application_id)');
    }
