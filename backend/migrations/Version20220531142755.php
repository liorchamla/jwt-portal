 ...
 */
final class Version20220531142755 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__proxy_route AS SELECT id, application_id, pattern FROM proxy_route');
        ...
        $this->addSql('INSERT INTO proxy_route (id, application_id, pattern) SELECT id, application_id, pattern FROM __temp__proxy_route');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__proxy_route AS SELECT id, application_id, pattern FROM proxy_route');
        $this->addSql('DROP TABLE proxy_route');
        $this->addSql('CREATE TABLE proxy_route (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, application_id INTEGER NOT NULL, pattern VARCHAR(255) NOT NULL)');
        $this->addSql('INSERT INTO proxy_route (id, application_id, pattern) SELECT id, application_id, pattern FROM __temp__proxy_route');
        $this->addSql('DROP TABLE __temp__proxy_route');
        $this->addSql('CREATE INDEX IDX_DBB88A543E030ACD ON proxy_route (application_id)');
    }
